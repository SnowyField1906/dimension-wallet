...
export default function Guide({ handleModal }) {
  return (
    <div className="transition ease-in-out duration-1000 absolute bg-white w-[80%]">
      {handleModal ? (
        <>
          <div className="transition ease-in-out duration-1000  justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="transition ease-in-out duration-1000 relative w-auto my-6 mx-auto max-w-3xl">
              <div className="transition ease-in-out duration-1000 border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-slate-900 outline-none focus:outline-none">
